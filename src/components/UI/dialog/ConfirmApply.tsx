...
export default function ConfirmApply({ isOpen, onClose }: Props) {
    ...
    <BaseDialog open={isOpen}>
        ...
        >
            <div className="content">   
                <h3 className="col_theme">Confirm Apply</h3>
                <p>alert_content_confirm</p>
            </div>
            <div className="clearall mar_top10">
                <div className="btnConfirm"><a href="https://career.vinasoy.com/en/jobs/apply/?id=433950">act_confirm</a></div>
            </div>
