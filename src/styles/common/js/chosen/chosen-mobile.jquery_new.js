  ...
  */  var $, Chosen, get_side_border_padding, root;
  ...
  Chosen = (function() {
    function Chosen(elmn) {
      ...
      this.form_field_jq.addClass("chosen-done");
    }
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.is_multiple) {
	   ...
	   container_div.html('<ul class="chosen-choices"><li class="search-field"><input type="text" value="' + this.default_text + '" class="default" autocomplete="off" style="width:25px;" readonly="true" /></li></ul><div class="chosen-drop" style="left:-9000px;"><ul class="chosen-results"></ul></div>');
      } else {
    ...
    Chosen.prototype.register_observers = function() {
	  ...
	  this.form_field_jq.bind("liszt:updatednew", __bind(function(evt) {
        return this.results_update_field_upgrate(evt);
      }, this));
    ...
    Chosen.prototype.container_click = function(evt) {
      ...
      if (!this.pending_destroy_click) {
        if (!this.active_field) {
          ...
          this.results_show();
        } else if (!this.is_multiple && evt && ($(evt.target) === this.selected_item || $(evt.target).parents("a.chosen-single").length)) {
          evt.preventDefault();
          this.results_toggle();
        }
	...
	Chosen.prototype.results_update_field_upgrate = function() {
      this.result_clear_highlight();
      this.result_single_selected = null;
      return this.results_build_upgrate();
    };
