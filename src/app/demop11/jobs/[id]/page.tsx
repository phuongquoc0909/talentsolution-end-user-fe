...
const JobsDetailPage: React.FC = () => {
    ...
    const [isOpenConfirmApply, setIsOpenConfirmApply] = useState(false);
    const handleConfirmApply = () => {
        setIsOpenConfirmApply(true);
    };
                            ...
                            <div className="col-xs-12 col-md-10 detail-head-right">
                                ...
                                <div className="col-xs-12 record-main">
                                    <div className="row">
                                        ...
                                        <span className="col-xs-12 col-sm-8 value">
                                ...
                                <div className="col-xs-12 actions-invite">
                                    <div className="sharejob">
                                        ...
                                        >
                                            Share
                                            {activeShareId === currentJob.JOB_ID && (
                            ...
                            <div className="col-xs-12 left-des">
                                ...
                                <div className="tagskilldetail">
                                    ...
                                    {currentJob.JOB_TAGS.map((tag, index) => (
                                        <a key={index} href={tag.TAG_URL} title={tag.TAG_NAME}>
                                            {tag.TAG_NAME}
                                        </a>
                                    ))}
                                </div>
